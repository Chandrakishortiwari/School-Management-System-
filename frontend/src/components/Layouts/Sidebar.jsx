...
import {
  ...
  CreditCard, Bell,LogOut, BookOpen, ClipboardList, X,UserPlus
} from 'lucide-react';
...
const navItems = {
  admin: [
    ...
    { to: '/studentaddmission', icon: UserPlus, label: 'New Student Addmission' },
    { to: '/teachers', icon: Users, label: 'Teachers' },
    { to: '/classes', icon: BookOpen, label: 'Classes' },
    { to: '/markattendance', icon: CalendarCheck, label: 'Mark Attendance' },
